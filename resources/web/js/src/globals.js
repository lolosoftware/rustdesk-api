...
function setRemoteCursor(value) {
    ...
    try {
        ...
        // Flutter sends PNG bytes with the historical image/rgba media type.
        const url = cursor.url.replace(
        ...
        console.error('Failed to apply the remote cursor', e);
        root.classList.remove('rustdesk-remote-cursor');
        root.style.removeProperty('--rustdesk-remote-cursor');
    }
}
